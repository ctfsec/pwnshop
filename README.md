...
Pwnshop is an intentionally vulnerable e-commerce platform built for hands-on web application penetration testing training. It covers 45 vulnerabilities mapped to the OWASP Top 10 (2025) and OWASP LLM Top 10, including SQL injection, stored XSS, SSRF, SSTI leading to RCE, prototype pollution, path traversal, business logic flaws, and AI/LLM-specific attack chains.

---

<img width="1905" height="1038" alt="image" src="https://github.com/user-attachments/assets/975f42e8-21bf-4ab1-8bc7-fbbffb1fc4f1" />
...
All 45 vulnerabilities are documented in-app at `/vulnerabilities` with descriptions, affected endpoints, and hints. The table below is a summary.
